                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                           SvgPicture.asset(AppAssets.weekIndicator, width: 24, height: 24),
                           const SizedBox(width: 4),
                           Text('Week 1/4', style: AppTypography.bodySmall.copyWith(color: Colors.white)),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text('9°', style: AppTypography.bodySmall.copyWith(color: Colors.white)),
                        ],
                      )
                    ],
                  ),
                         ...
                         child: Container(
                           ...
                           child: Center(
                             child: Text(
                               ...
                               style: AppTypography.caption.copyWith(color: const Color(0xFFA7C0C6)),
                             ),
                           ),
                         ),
                      )
